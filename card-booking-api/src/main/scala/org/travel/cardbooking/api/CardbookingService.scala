package org.travel.cardbooking.api
...
object CardbookingService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The card-booking service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the CardbookingService.
  */
trait CardbookingService extends Service {
  ...
  override final def descriptor = {
    ...
    named("card-booking")
      ...
      .withTopics(
        topic(CardbookingService.TOPIC_NAME, greetingsTopic)
