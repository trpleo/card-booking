...
/**
  * This is an event sourced entity. It has a state, [[CardbookingState]], which
  ...
  */
class CardbookingEntity extends PersistentEntity {

  override type Command = CardbookingCommand[_]
  override type Event = CardbookingEvent
  override type State = CardbookingState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: CardbookingState = CardbookingState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case CardbookingState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        CardbookingState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class CardbookingState(message: String, timestamp: String)

object CardbookingState {
  /**
    ...
    */
  implicit val format: Format[CardbookingState] = Json.format
}

/**
  * This interface defines all the events that the CardbookingEntity supports.
  */
sealed trait CardbookingEvent extends AggregateEvent[CardbookingEvent] {
  def aggregateTag = CardbookingEvent.Tag
}

object CardbookingEvent {
  val Tag = AggregateEventTag[CardbookingEvent]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends CardbookingEvent
...
/**
  ...
  */
sealed trait CardbookingCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends CardbookingCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends CardbookingCommand[String]
...
/**
  ...
  * application loader.
  */
object CardbookingSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[CardbookingState]
  )
}
